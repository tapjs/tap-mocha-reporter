...
/**
 * Determine if we are running in a node-like environment (even when certain browser
 * APIs have been mocked.)
 */
function runningInNode() {
  ...
  if (typeof process !== 'undefined') {
    // NOTE: electron has 'node' in this location, so we won't go out of our way for it
    return /(node|iojs)/.test(((process || {}).release || {}).name)
  }
